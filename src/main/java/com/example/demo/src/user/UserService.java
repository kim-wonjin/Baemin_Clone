...
public class UserService {
    ...
    public String getKaKaoAccessToken(String code){
        ...
        try{
            ...
            sb.append("&client_id=80acc5bc8b3398f8c905bc948c326bd5"); // TODO REST_API_KEY 입력
            sb.append("&redirect_uri=http://localhost:9000/api/users/kakao"); // TODO 인가코드 받은 redirect_uri 입력
            sb.append("&code=" + code);
    ...
    public BaseResponse<PostKakaoRes> createKakaoUser(String token) throws BaseException {
